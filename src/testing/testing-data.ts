import { Issue, IssueChartData } from '../app/shared/models/issue-interface';
import { Publisher } from '../app/shared/models/publisher-interface';
import { Title } from '../app/shared/models/title-interface';
...
export const fakeIssuePublishersData: IssueChartData[] = [
  { name: 'p1', value: 2 },
  { name: 'p2', value: 1 },
];

export const fakeIssueTitlesData: IssueChartData[] = [
  { name: 't1', value: 2 },
  { name: 't2', value: 1 },
];
